...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/b--b/CM-Sources/UBER/out/arm-linux-androideabi-4.8-cortex-a15/arm-linux-androideabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
